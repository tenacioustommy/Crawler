...
debugger;
(function () {
    var url = "https://www.toutiao.com/index.html";
    var referrer = "https://www.toutiao.com/index.html";
    dogvm.init(url, referrer);
}());
...
// dogvm.baseMemory.cookie = "msToken=0aGU_F6SOeFO9PgpjF1DN2z2giLFLYSy-eW1L9Eys8zxNDBTOWfd6rrGxWbS25ToIOEQ-p9A_QxB7CihOKAmd_1gsRw5McFMgn98xzruqWcX; __ac_nonce=0620f5b6400277a0c24b5";
...
function get_signature_url(url_, cookie_) {
    ...
    dogvm.debugconfig.ifdebugger = true;
    result = I(url_, {});
    return result;
}
