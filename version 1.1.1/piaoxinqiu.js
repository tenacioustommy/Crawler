...
// var web_js_code1 = fs.readFileSync(`${__dirname}/Sites/pxqindex.js`); // 获取目标网站js代码
var web_js_code2 = fs.readFileSync(`${__dirname}/Sites/piaoxinqiu.js`); // 获取目标网站js代码

var all_code = toolscode + browsercode + log_code + web_js_code2;
